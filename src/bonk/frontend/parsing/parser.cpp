...
CompilerMessageStreamProxy Parser::warning() const { return compiler.warning(); }
CompilerMessageStreamProxy Parser::error() {
    errors_occurred = true;
    return compiler.error();
}
CompilerMessageStreamProxy Parser::fatal_error() {
    errors_occurred = true;

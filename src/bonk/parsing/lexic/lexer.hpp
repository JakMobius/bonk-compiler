...
enum class KeywordType { k_buul, k_shrt, k_nubr, k_long, k_flot, k_dabl, k_strg, k_many, k_nothing, k_null };
...
enum class NumberConstantKind : char { rather_integer, rather_double };
